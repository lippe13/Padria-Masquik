...
-- -----------------------------------------------------
-- Table `Padaria`.`TF_Cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Padaria`.`TF_Cliente` (
...
-- -----------------------------------------------------
-- Table `Padaria`.`TF_Pedido`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Padaria`.`TF_Pedido` (
  ...
  CONSTRAINT `fk_Pedido_Cliente`
    ...
    REFERENCES `Padaria`.`TF_Cliente` (`idCliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

-- -----------------------------------------------------
-- Table `Padaria`.`TF_Funcionario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Padaria`.`TF_Funcionario` (
...
-- -----------------------------------------------------
-- Table `Padaria`.`TF_Produto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Padaria`.`TF_Produto` (
...
-- -----------------------------------------------------
-- Table `Padaria`.`TF_Gerente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Padaria`.`TF_Gerente` (
...
-- -----------------------------------------------------
-- Table `Padaria`.`TF_ADM`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Padaria`.`TF_ADM` (
...
-- -----------------------------------------------------
-- Table `Padaria`.`Pedido_has_Produto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Padaria`.`Pedido_has_Produto` (
  ...
  CONSTRAINT `fk_TF_Pedido_has_TF_Produto_TF_Pedido1`
    ...
    REFERENCES `Padaria`.`TF_Pedido` (`idPedido`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TF_Pedido_has_TF_Produto_TF_Produto1`
    FOREIGN KEY (`TF_Produto_idProduto`)
    REFERENCES `Padaria`.`TF_Produto` (`idProduto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;


--inserção prévia de pedidos
INSERT INTO Padaria.TF_Produto (Nome, PrecoUnitario, Desconto, Estoque, Fornecedor) VALUES
